...
def dataSelection(Data):
    ...
    for t in range(startTime,endTime,dt):
        ...
        if t == startTime:
            ...
            sel = 10000*Data.loc[(Data['ist_ab_nach']>t- 4800 ) & (Data['ist_ab_nach']<t+dt),{'Linienname','halt_diva_nach'}].drop_duplicates()['Linienname']+Data.loc[(Data['ist_ab_nach']>t-4800 ) & (Data['ist_ab_nach']<t+dt),{'Linienname','halt_diva_nach'}].drop_duplicates()['halt_diva_nach']
            FrameT.loc[idx[sel,:],t] = pd.DataFrame(
                {'Delta_stops'  :(Data.loc[(Data['ist_ab_nach']>t- 4800 ) & (Data['ist_ab_nach']<t+dt),'ist_ab_nach']-Data.loc[(Data['ist_ab_nach']>t- 4800  ) & (Data['ist_ab_nach']<t+dt),'ist_an_nach1']-Data.loc[(Data['ist_ab_nach']>t- 4800  ) & (Data['ist_ab_nach']<t+dt),'soll_ab_nach']+Data.loc[(Data['ist_ab_nach']>t -4800) & (Data['ist_ab_nach']<t+dt),'soll_an_nach']),
                 'Delta_trip'   :Data.loc[(Data['ist_ab_nach']>t- 4800 ) & (Data['ist_ab_nach']<t+dt),'ist_an_nach1']-Data.loc[(Data['ist_ab_nach']>t- 4800  ) & (Data['ist_ab_nach']<t+dt),'ist_ab_von']-Data.loc[(Data['ist_ab_nach']>t- 4800  ) & (Data['ist_ab_nach']<t+dt),'soll_an_nach']+Data.loc[(Data['ist_ab_nach']>t -4800) & (Data['ist_ab_nach']<t+dt),'soll_ab_von'],
                 'Tot_lat'      :Data.loc[(Data['ist_ab_nach']>t- 4800 ) & (Data['ist_ab_nach']<t+dt),'ist_ab_nach']-Data.loc[(Data['ist_ab_nach']>t- 4800  ) & (Data['ist_ab_nach']<t+dt),'soll_ab_nach'],
                 'Is_connected' :Data.loc[(Data['ist_ab_nach']>t- 4800 ) & (Data['ist_ab_nach']<t+dt),'Connected'].values,
                 
                  'IsBus'        : ((Data.loc[(Data['ist_ab_nach']>t -4800) & (Data['ist_ab_nach']<t+dt),'VSYS'].values == 'B' )|(
                                   Data.loc[(Data['ist_ab_nach']>t -4800) & (Data['ist_ab_nach']<t+dt),'VSYS'].values == 'TB')).astype('float'),
            
                 'IsTram'       :(Data.loc[(Data['ist_ab_nach']>t -4800) & (Data['ist_ab_nach']<t+dt),'VSYS'] == 'T').astype('float'),
                 
                 'IsOther'      :((Data.loc[(Data['ist_ab_nach']>t -4800) & (Data['ist_ab_nach']<t+dt),'VSYS'].values != 'B' ) & (
                                  Data.loc[(Data['ist_ab_nach']>t -4800) & (Data['ist_ab_nach']<t+dt),'VSYS'].values != 'T') & (
                                  Data.loc[(Data['ist_ab_nach']>t -4800) & (Data['ist_ab_nach']<t+dt),'VSYS'].values != 'TB')).astype('float'),
                 
                 
                 'Time'         :Data.loc[(Data['ist_ab_nach']>t- 4800 ) & (Data['ist_ab_nach']<t+dt),'ist_ab_nach'].values,
                 'Dist'         :Data.loc[(Data['ist_ab_nach']>t- 4800 ) & (Data['ist_ab_nach']<t+dt),'GPS_Longitude'].values,
                 'Lat'          :Data.loc[(Data['ist_ab_nach']>t- 4800 ) & (Data['ist_ab_nach']<t+dt),'GPS_Latitude'].values,
                 'ID'           : 10000*Data.loc[(Data['ist_ab_nach']>t- 4800 ) & (Data['ist_ab_nach']<t+dt),'Linienname']+Data.loc[(Data['ist_ab_nach']>t- 4800 ) & (Data['ist_ab_nach']<t+dt),'halt_diva_nach']}
            ...
            BusPos[t] = Data.loc[(Data['ist_ab_nach']>t -4800 ) & (Data['ist_ab_nach']<t+dt) & (Data['fahrzeug']==Bus_id),['GPS_Latitude','GPS_Longitude']].drop_duplicates(keep = 'last').T.values
            ...
            FrameT.loc[idx[sel,:],t] = pd.DataFrame(
                {'Delta_stops'  :(Data.loc[(Data['ist_ab_nach']>t ) & (Data['ist_ab_nach']<t+dt),'ist_ab_nach']-Data.loc[(Data['ist_ab_nach']>t ) & (Data['ist_ab_nach']<t+dt),'ist_an_nach1']-Data.loc[(Data['ist_ab_nach']>t ) & (Data['ist_ab_nach']<t+dt),'soll_ab_nach']+Data.loc[(Data['ist_ab_nach']>t ) & (Data['ist_ab_nach']<t+dt),'soll_an_nach']),
                 ...
                 'IsTram'       :(Data.loc[(Data['ist_ab_nach']>t ) & (Data['ist_ab_nach']<t+dt),'VSYS'] == 'T').astype('float'),
                 
                 'IsOther'      :((Data.loc[(Data['ist_ab_nach']>t ) & (Data['ist_ab_nach']<t+dt),'VSYS'].values != 'B' ) & (
                                  Data.loc[(Data['ist_ab_nach']>t ) & (Data['ist_ab_nach']<t+dt),'VSYS'].values != 'T') & (
                                  Data.loc[(Data['ist_ab_nach']>t ) & (Data['ist_ab_nach']<t+dt),'VSYS'].values != 'TB')).astype('float'),
...
if FrameT.shape[1] % 9 != 0 :
    raise NameError('The FrameT is not a multiple of the features')
...
InputData = Input((FrameT.shape[1],)) 
ip = 0
for i in range(9,FrameT.shape[1],9):
    groupi = Lambda(lambda x: x[:,ip:i], output_shape=((9,)))(InputData)    
...
auto = Model(inputs=InputData, outputs=merged)
